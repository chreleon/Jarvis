...
- **`phone screenshot`** — captures the screen to `phone_shots/`; add "and describe it" to have Jeeves analyze it with vision ("what's on my phone right now?").
